...
import FacultySearchStudent from "../../components/FacultySearchStudent";
...
export const FacultySearchStudentScreen1 = ({ route, navigation }) => {
  ...
  const student_name = JSON.stringify(sname).replace(/\"/g, "");
